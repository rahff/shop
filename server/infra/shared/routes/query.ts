...
export class QueryRouter {
    ...
    private init(): void {
        ...
        this.router.get('/query/cart/:id', this.queryCartController.getCart.bind(this.queryCartController));
        ...
        this.router.get('/query/productPage', this.queryShopController.shopPage.bind(this.queryShopController));
        
        this.router.post("/query/auth/local", this.queryUserController.login.bind(this.queryUserController));
    }
